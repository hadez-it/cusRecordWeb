...
if (isset($_SESSION['id']) && isset($_SESSION['username'])) {
 ...
 function urgAssCheck() {
    if (document.getElementById('Urg').checked) {
        ...
        document.getElementById('warranty').style.display = 'flex';
    } else {
        document.getElementById('inputError').style.display = 'none';
        document.getElementById('warranty').style.display = 'none';
        //document.getElementById('inputError').remove();
        //document.getElementById('warranty').remove();
    }
}
</script>
    ...
    <form action="addrecord.php" method="post">
      <div class="form">
        ...
        <div class="inputfield">
          ...
          <input type="number" class="input" name="phNo">
        </div>
        <div class="inputfield">
          <label>City</label>
