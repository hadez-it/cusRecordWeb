...
include "db_conn.php";
  ...
  if (isset($_POST['pModel'])){
    ...
    if (empty($_POST["pModel"])) {
      ...
      $sql = "INSERT INTO records(Name,Phone,City,ProductType,Warranty,ModelName,Serialnumber,Error,Solution,TechName,recordDate,AsUrg) VALUES('$cusName','$phNo','$city','$productType','$warranty','$pModel','$pSN','$cusError','$solution','$user','$recordDate','$radioRecordCheck')";
